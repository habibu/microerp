    ...
    public void addColumnToReportBuilder(String columnName, FastReportBuilder builder, Locale locale, String fileName) {
        try {
            if (columnName.equals("id")) {
                ...
                builder.addColumn(getMessageSource().getMessage("label_supplier_name", null, "Name", locale), "name", String.class.getName(), 100);
            ...
            } else if (columnName.equals("webaddress")) {
                builder.addColumn(getMessageSource().getMessage("label_supplier_webaddress", null, "Webaddress", locale), "webaddress", String.class.getName(), 100);
            }
