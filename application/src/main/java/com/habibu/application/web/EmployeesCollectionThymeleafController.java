...
public class EmployeesCollectionThymeleafController {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Employee>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
