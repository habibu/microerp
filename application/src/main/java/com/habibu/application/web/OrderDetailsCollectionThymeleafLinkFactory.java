...
/**
 * = OrderDetailsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = OrderDetailsCollectionThymeleafController.class)
@Component
public class OrderDetailsCollectionThymeleafLinkFactory implements MethodLinkFactory<OrderDetailsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<OrderDetailsCollectionThymeleafController> getControllerClass() {
        return OrderDetailsCollectionThymeleafController.class;
    }
