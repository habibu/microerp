...
/**
 * = CountriesItemStoresThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = CountriesItemStoresThymeleafController.class)
@Component
public class CountriesItemStoresThymeleafLinkFactory implements MethodLinkFactory<CountriesItemStoresThymeleafController> {
     ...
     * @return Class
     */
    public Class<CountriesItemStoresThymeleafController> getControllerClass() {
        return CountriesItemStoresThymeleafController.class;
    }
