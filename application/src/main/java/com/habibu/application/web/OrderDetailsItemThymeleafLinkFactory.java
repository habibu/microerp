...
/**
 * = OrderDetailsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = OrderDetailsItemThymeleafController.class)
@Component
public class OrderDetailsItemThymeleafLinkFactory implements MethodLinkFactory<OrderDetailsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<OrderDetailsItemThymeleafController> getControllerClass() {
        return OrderDetailsItemThymeleafController.class;
    }
