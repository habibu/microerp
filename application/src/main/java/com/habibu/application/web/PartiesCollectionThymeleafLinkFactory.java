...
/**
 * = PartiesCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PartiesCollectionThymeleafController.class)
@Component
public class PartiesCollectionThymeleafLinkFactory implements MethodLinkFactory<PartiesCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<PartiesCollectionThymeleafController> getControllerClass() {
        return PartiesCollectionThymeleafController.class;
    }
