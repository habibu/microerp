...
/**
 * = ReportsItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReportsItemThymeleafController.class)
@Component
public class ReportsItemThymeleafLinkFactory implements MethodLinkFactory<ReportsItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReportsItemThymeleafController> getControllerClass() {
        return ReportsItemThymeleafController.class;
    }
