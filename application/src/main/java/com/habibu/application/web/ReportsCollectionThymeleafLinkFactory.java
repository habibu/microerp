...
/**
 * = ReportsCollectionThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = ReportsCollectionThymeleafController.class)
@Component
public class ReportsCollectionThymeleafLinkFactory implements MethodLinkFactory<ReportsCollectionThymeleafController> {
     ...
     * @return Class
     */
    public Class<ReportsCollectionThymeleafController> getControllerClass() {
        return ReportsCollectionThymeleafController.class;
    }
