...
public class ShippersCollectionThymeleafController {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<Shipper>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
