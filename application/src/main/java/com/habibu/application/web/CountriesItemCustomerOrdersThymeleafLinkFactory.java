...
/**
 * = CountriesItemCustomerOrdersThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = CountriesItemCustomerOrdersThymeleafController.class)
@Component
public class CountriesItemCustomerOrdersThymeleafLinkFactory implements MethodLinkFactory<CountriesItemCustomerOrdersThymeleafController> {
     ...
     * @return Class
     */
    public Class<CountriesItemCustomerOrdersThymeleafController> getControllerClass() {
        return CountriesItemCustomerOrdersThymeleafController.class;
    }
