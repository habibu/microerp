...
/**
 * = CountriesItemPartiesThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = CountriesItemPartiesThymeleafController.class)
@Component
public class CountriesItemPartiesThymeleafLinkFactory implements MethodLinkFactory<CountriesItemPartiesThymeleafController> {
     ...
     * @return Class
     */
    public Class<CountriesItemPartiesThymeleafController> getControllerClass() {
        return CountriesItemPartiesThymeleafController.class;
    }
