...
public class SoldProductsCollectionThymeleafController {
    ...
    @ResponseBody
    public ResponseEntity<ConvertedDatatablesData<SoldProduct>> datatablesByIdsIn(@RequestParam("ids") List<Long> ids, DatatablesColumns datatablesColumns, GlobalSearch search, DatatablesPageable pageable, @RequestParam("draw") Integer draw) {
