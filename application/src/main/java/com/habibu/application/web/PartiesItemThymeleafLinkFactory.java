...
/**
 * = PartiesItemThymeleafLinkFactory
 *
 * TODO Auto-generated class documentation
 *
 */
@RooLinkFactory(controller = PartiesItemThymeleafController.class)
@Component
public class PartiesItemThymeleafLinkFactory implements MethodLinkFactory<PartiesItemThymeleafController> {
     ...
     * @return Class
     */
    public Class<PartiesItemThymeleafController> getControllerClass() {
        return PartiesItemThymeleafController.class;
    }
