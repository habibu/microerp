...
@Entity
@EntityFormat
@XmlRootElement(name = "city", namespace = "http://ws.habibu.com/")
public class QCity {

    public static final QCity city = null;
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof QCity)) {
            return false;
        }
        return getId() != null && Objects.equals(getId(), ((QCity) obj).getId());
    }
